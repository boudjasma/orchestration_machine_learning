...
# prediction_trajet_nyc documentation build
...
from prediction_trajet_nyc import __version__ as release

# -- Project information -----------------------------------------------------

project = "prediction_trajet_nyc"
author = "Kedro"
...
htmlhelp_basename = "prediction_trajet_nycdoc"
...
latex_documents = [
    (
        master_doc,
        "prediction_trajet_nyc.tex",
        "prediction_trajet_nyc Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "prediction_trajet_nyc",
        "Project prediction_trajet_nyc codebase.",
        "Data-Science",
    )
]
